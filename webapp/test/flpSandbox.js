		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "timesheet app",
									"targetURL": "#sapcomtimesheet-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapcomtimesheet-display": {
								"semanticObject": "sapcomtimesheet",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.com.timesheet",
									"url": sap.ui.require.toUrl("sap/com/timesheet")
								}
							}
						}
					}
